...
-----------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------
--------------- Use Below query to Insert the Data in the above created Tables ----------------
-----------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------

-- Part 2 : Inserting data in each tables
...
-- Part 3 : Verifying data in each tables
...
/
  ...
  -- Sample query for checking the count in regions table
...
-- To check the count of records in each tables:
...
-- PL/SQL way of checking the count in tables :
...
BEGIN
    ...
    SELECT COUNT(*) INTO inventories_count
    FROM inventories;

    SELECT COUNT(*) INTO products_count
    FROM products;

    SELECT COUNT(*) INTO product_categories_count
    FROM product_categories;

    SELECT COUNT(*) INTO warehouses_count
    FROM warehouses;
...
-- To print the output to verify the count of records in Each Tables :

    DBMS_OUTPUT.PUT_LINE('order_items_count = ' || order_items_count);
    DBMS_OUTPUT.PUT_LINE('orders_count = ' || orders_count);
    DBMS_OUTPUT.PUT_LINE('inventories_count = ' || inventories_count);
    DBMS_OUTPUT.PUT_LINE('products_count = ' || products_count);
    DBMS_OUTPUT.PUT_LINE('product_categories_count = ' || product_categories_count);
    DBMS_OUTPUT.PUT_LINE('warehouses_count = ' || warehouses_count);
    DBMS_OUTPUT.PUT_LINE('employees_count = ' || employees_count);
    DBMS_OUTPUT.PUT_LINE('contacts_count = ' || contacts_count);
    DBMS_OUTPUT.PUT_LINE('customers_count = ' || customers_count);
    DBMS_OUTPUT.PUT_LINE('locations_count = ' || locations_count);
    DBMS_OUTPUT.PUT_LINE('countries_count = ' || countries_count);
    DBMS_OUTPUT.PUT_LINE('regions_count = ' || regions_count);
END;
/
